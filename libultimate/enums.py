...
class Action:
    ...
    ACTION_DOWN_TILT = [Button.BUTTON_MODIFIER, Button.BUTTON_DOWN, Button.BUTTON_A]
    ...
    ACTION_RIGHT_SPECIAL = [Button.BUTTON_S_RIGHT, Button.BUTTON_D]
    ACTION_LEFT_SPECIAL = [Button.BUTTON_S_LEFT, Button.BUTTON_D]
    ACTION_UP_SPECIAL = [Button.BUTTON_S_UP, Button.BUTTON_D]
    ACTION_DOWN_SPECIAL = [Button.BUTTON_S_DOWN, Button.BUTTON_D]
    ...
    ACTION_RIGHT_DASH = [Button.BUTTON_C_RIGHT]
    ACTION_LEFT_DASH = [Button.BUTTON_C_LEFT]
    ACTION_RIGHT_WALK = [Button.BUTTON_MODIFIER, Button.BUTTON_C_RIGHT]
    ACTION_LEFT_WALK = [Button.BUTTON_MODIFIER, Button.BUTTON_C_LEFT]
    ACTION_CROUCH = [Button.BUTTON_C_DOWN]
    ACTION_RIGHT_CRAWL = [Button.BUTTON_C_DOWN, Button.BUTTON_C_RIGHT]
    ACTION_LEFT_CRAWL = [Button.BUTTON_C_DOWN, Button.BUTTON_C_LEFT]
    ACTION_RIGHT_STICK = [Button.BUTTON_C_RIGHT]
