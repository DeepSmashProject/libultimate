...
class Action:
    ...
    ACTION_SPOT_DODGE = [Button.BUTTON_ZR, Button.BUTTON_S_DOWN]
    ACTION_RIGHT_ROLL = [Button.BUTTON_ZR, Button.BUTTON_S_RIGHT]
    ACTION_LEFT_ROLL = [Button.BUTTON_ZR, Button.BUTTON_S_LEFT]
