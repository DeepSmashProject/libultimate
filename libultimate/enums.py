...
class Action:
    ...
    ACTION_SPOT_DODGE = [Button.BUTTON_Z, Button.BUTTON_S_DOWN]
    ACTION_RIGHT_ROLL = [Button.BUTTON_Z, Button.BUTTON_S_RIGHT]
    ACTION_LEFT_ROLL = [Button.BUTTON_Z, Button.BUTTON_S_LEFT]
    ACTION_RIGHT_DASH = [Button.BUTTON_S_RIGHT]
    ACTION_LEFT_DASH = [Button.BUTTON_S_LEFT]
    ...
    ACTION_RIGHT_CRAWL = [Button.BUTTON_S_DOWN, Button.BUTTON_MODIFIER, Button.BUTTON_S_RIGHT]
    ACTION_LEFT_CRAWL = [Button.BUTTON_S_DOWN, Button.BUTTON_MODIFIER, Button.BUTTON_S_LEFT]
