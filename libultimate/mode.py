...
class TrainingMode(Mode):
    ...
    def _move_to_training_mode(self):
        ...
        self._controller.multi_press([Button.BUTTON_S_RIGHT], sec=0.02)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_UP], sec=0.02)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_A], sec=0.02)
        time.sleep(1)

        # To Training from Games & More
        self._controller.multi_press([Button.BUTTON_S_DOWN], sec=0.02)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_LEFT], sec=0.02)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_A], sec=0.02)
    ...
    def _select_player(self):
        ...
        ## Player Select
        ### to left top corner
        self._controller.multi_press([Button.BUTTON_S_UP], sec=3)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_LEFT], sec=3)
        time.sleep(0.1)
        ### to mario
        self._controller.multi_press([Button.BUTTON_S_RIGHT], sec=0.25)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_DOWN], sec=0.30)
        time.sleep(0.1)
        ### to fighter
        ...
        for k in range(player_row):
            self._controller.multi_press([Button.BUTTON_S_RIGHT], sec=0.37)
            time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_A], sec=0.02)
        time.sleep(1)
    ...
    def _select_cpu(self):
        ...
        self._controller.multi_press([Button.BUTTON_S_UP], sec=3)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_RIGHT], sec=3)
        time.sleep(0.1)
        ### to random
        self._controller.multi_press([Button.BUTTON_S_LEFT], sec=0.25)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_DOWN], sec=0.60)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_A], sec=0.02)
        ## Select CPU
        ### to left top corner
    ...
    def _change_cpu_level(self):
        ...
        self._controller.multi_press([Button.BUTTON_S_DOWN], sec=3)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_RIGHT], sec=3)
        time.sleep(0.1)
        ### to level
        self._controller.multi_press([Button.BUTTON_S_UP], sec=0.2)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_LEFT], sec=0.5)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_A], sec=0.02)
        ### Change Level
        if self._cpu_level >= 3:
            ...
            for i in range(3 - self._cpu_level):
                self._controller.multi_press([Button.BUTTON_S_DOWN], sec=0.2)
                time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_A], sec=0.02)
        time.sleep(1)
    ...
    def _set_training_setting(self):
        ...
        for i in range(4):
            self._controller.multi_press([Button.BUTTON_S_DOWN], sec=0.2)
            time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_RIGHT], sec=0.2)
        time.sleep(0.1)
        ...
        self._controller.multi_press([Button.BUTTON_S_DOWN], sec=0.2)
        time.sleep(0.1)
        self._controller.multi_press([Button.BUTTON_S_LEFT], sec=0.2)
        time.sleep(0.1)
        # Finish Settings
        self._controller.multi_press([Button.BUTTON_PLUS], sec=0.02)
        time.sleep(1)
